        ...
        for (User user : users) {
            ...
            if (mostFrequent != null) {
                ...
                try {
                    ...
                    log.info("Sent data to kafka for "+sentimentData.getEmail());
                } catch (Exception e) {
                    emailService.sendEmail(sentimentData.getEmail(),  "Sentiment for previous week", sentimentData.getSentiment()+ LocalDateTime.now());
